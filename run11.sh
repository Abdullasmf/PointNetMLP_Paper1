...
#SBATCH --output=PointNetMLP_Paper1/GPU11.log
#SBATCH --error=PointNetMLP_Paper1/GPU11.log
...
python -u PointNetMLP_Paper1/Point++_DeepONet_wSDF_FFM_CAtt_v2/GPU3.py
